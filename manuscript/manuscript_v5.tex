...
Analyses were conducted in Python 3.10+ (NumPy, SciPy, Matplotlib). All results, tables, and figures are regenerated by a single \texttt{make} pipeline with pinned seed 42 and regression tests on the deterministic invariants; code and data are at \url{https://github.com/Nyx-Dynamics/algorithmic-bias-epidemiology-academic} and archived at Zenodo (DOI:10.5281/zenodo.18746745).
...
All data and code are archived at Zenodo (DOI:10.5281/zenodo.18746745) and available at \url{https://github.com/Nyx-Dynamics/algorithmic-bias-epidemiology-academic}. A one-command \texttt{make} pipeline reproduces all results, tables, and figures (seed 42).
