...
**ORCID:** [To be provided upon submission]
...
- **Abstract:** 248 words
- **Main Text:** ~2,800 words (Introduction through Conclusion)
- **References:** 14
- **Tables:** 6
- **Figures:** 5
...
- **Investigation:** ACD
- **Data Curation:** ACD
- **Writing - Original Draft:** ACD
- **Writing - Review & Editing:** ACD
- **Visualization:** ACD
- **Project Administration:** ACD

---

## Acknowledgments

The author thanks the open-source software communities whose tools made this analysis possible, including NumPy, SciPy, Matplotlib, and SALib.
